...
lattice_constants = [4.179, 3.969, 3.839] # From T1
...
for i in range(3):
  ...
  calc.write(f'{materialList[i]}.gpw') # Save wavefunction for upcoming tasks
  ...
  # Calculating the surface energy acc to E_surface = (E_potential - N*E_bulk)/2A
