...
calc_deca = gp.GPAW(mode=PW(200),xc='PBE',txt='pw200_PBE/pw200_LDA_deca.txt')
calc_tree = gp.GPAW(mode=PW(200),xc='PBE',txt='pw200_PBE/pw200_LDA_tree.txt')

deca.set_calculator(calc_deca)
tree.set_calculator(calc_tree)

# Optimizing
opt_deca = BFGS(deca,logfile='pw200_PBE/bfgs_deca.log')
opt_tree = BFGS(tree,logfile='pw200_PBE/bfgs_tree.log')
