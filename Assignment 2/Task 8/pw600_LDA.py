...
calc_deca = gp.GPAW(mode=PW(600),xc='LDA',txt='pw600_LDA/pw600_LDA_deca.txt')
calc_tree = gp.GPAW(mode=PW(600),xc='LDA',txt='pw600_LDA/pw600_LDA_tree.txt')

deca.set_calculator(calc_deca)
tree.set_calculator(calc_tree)

# Optimizing
opt_deca = BFGS(deca,logfile='pw600_LDA/bfgs_deca.log')
opt_tree = BFGS(tree,logfile='pw600_LDA/bfgs_tree.log')
