...
calc_deca = gp.GPAW(mode='fd',h=0.15,xc='PBE',txt='fd015_PBE/fd_PBE_deca.txt')
calc_tree = gp.GPAW(mode='fd',h=0.15,xc='PBE',txt='fd015_PBE/fd_PBE_tree.txt')

deca.set_calculator(calc_deca)
tree.set_calculator(calc_tree)

# Optimizing
opt_deca = BFGS(deca,logfile='fd015_PBE/bfgs_deca.log')
opt_tree = BFGS(tree,logfile='fd015_PBE/bfgs_tree.log')
