...
calc_deca = gp.GPAW(mode='fd',xc='PBE',txt='fd_PBE/fd_PBE_deca.txt')
calc_tree = gp.GPAW(mode='fd',xc='PBE',txt='fd_PBE/fd_PBE_tree.txt')

deca.set_calculator(calc_deca)
tree.set_calculator(calc_tree)

# Optimizing
opt_deca = BFGS(deca,logfile='fd_PBE/bfgs_deca.log')
opt_tree = BFGS(tree,logfile='fd_PBE/bfgs_tree.log')
